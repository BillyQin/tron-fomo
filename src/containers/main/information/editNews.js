...
import { newDetail, newsSave } from '../../../utils/request';
...
class EditNews extends Component {
    constructor(props) {
      ...
      getData = (id) => {
        newDetail({id:id}).then(data => {
          if (data) {
            this.state.fileListUrl[0].url = data.icon
            this.state.editor = data.prospectus
...
const EditNewsType = Form.create()(EditNews)
export default EditNewsType