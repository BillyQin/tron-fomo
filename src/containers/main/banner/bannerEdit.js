...
import { bannerEdit,bannerDetail } from '../../../utils/request';
...
class BannerEdit extends Component {
    constructor(props) {
      ...
      getData = (id) => {
        bannerDetail({id:id}).then(data => {
          if (data) {
            this.state.fileListUrl[0].url = data.url
          ...
          <div className="">
            ...
            <Form onSubmit={this.handleSubmit} className="formRow" layout="inline">
                <FormItem label="BannerType">
                    ...
                    rules: [{ required: true, message: '请输入bannerType!' }]
                    })(
...
const BannerEditType = Form.create()(BannerEdit)
export default BannerEditType